...
function Home() {
    return (
        <div>
            <div className='bg-[#1D217C] w-full h-[80vh] 2xl:px-[100px] 2xl:pt-[40px]  relative '>
                <div className='flex lg:flex-row flex-col w-full relative '>
                    <Header />
                    <div className=''>
                        <div className='flex flex-col gap-y-5 items-center mt-[20vh] 2xl:ml-10 justify-start'>
