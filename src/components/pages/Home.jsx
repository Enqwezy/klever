            ...
            <div className="bg-[#1D217C] w-full h-[60vh] sm:h-[70vh] lg:h-[80vh] px-4 sm:px-6 lg:px-12 xl:px-[100px] pt-6 lg:pt-[40px] relative">
                <div className="flex flex-col lg:flex-row w-full relative">
                    ...
                    <div className="flex flex-col lg:flex-row w-full items-center lg:items-start">
                        <div className="flex flex-col gap-y-3 sm:gap-y-4 xl:gap-y-5 items-center mt-[10vh] sm:mt-[15vh] lg:mt-[20vh] lg:ml-0 xl:ml-10">
                            <Link
                                to="/beauty"
                                className="bg-white px-4 sm:px-6 xl:px-8 text-[#141414] font-eastman_regular rounded-[15px] sm:rounded-[20px] text-[18px] sm:text-[22px] xl:text-[25px] flex justify-center w-[220px] sm:w-[250px] xl:w-[300px] py-2 hover:bg-gray-100 transition-all duration-200"
                            >
                                Красота и здоровье
                            </Link>
                            <Link
                                to="/cleaning"
                                className="bg-white px-4 sm:px-6 xl:px-8 text-[#141414] font-eastman_regular rounded-[15px] sm:rounded-[20px] text-[18px] sm:text-[22px] xl:text-[25px] flex justify-center w-[180px] sm:w-[195px] xl:w-[220px] py-2 hover:bg-gray-100 transition-all duration-200"
                            >
                                Клининг
                            </Link>
                            <Link
                                to="/tutoring"
                                className="bg-white px-4 sm:px-6 xl:px-8 text-[#141414] font-eastman_regular rounded-[15px] sm:rounded-[20px] text-[18px] sm:text-[22px] xl:text-[25px] flex justify-center w-[240px] sm:w-[270px] xl:w-[300px] py-2 hover:bg-gray-100 transition-all duration-200"
                            >
                                Репетиторство
                            </Link>
                            <Link
                                to="/building"
                                className="bg-white px-4 sm:px-6 xl:px-8 text-[#141414] font-eastman_regular rounded-[15px] sm:rounded-[20px] text-[18px] sm:text-[22px] xl:text-[25px] flex justify-center w-[230px] sm:w-[260px] xl:w-[295px] py-2 hover:bg-gray-100 transition-all duration-200"
                            >
                                Строительство
                            </Link>
                            <Link
                                to="/med_service"
                                className="bg-white px-4 sm:px-6 xl:px-8 text-[#141414] font-eastman_regular rounded-[15px] sm:rounded-[20px] text-[18px] sm:text-[22px] xl:text-[25px] flex justify-center w-[200px] sm:w-[220px] xl:w-[240px] py-2 hover:bg-gray-100 transition-all duration-200"
                            >
                                Мед Услуги
                            </Link>
                        </div>
