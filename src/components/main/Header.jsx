    ...
    <div className='flex justify-center mt-5'>
      ...
      <div className=' flex flex-row gap-10 w-[80vw] justify-between'>
        ...
        <div className='flex flex-row gap-5 md:gap-6 lg:gap-7 xl:gap-10 2xl:items-center '>
          <div className=''>
            <svg className='w-[40px] h-[40px] 2xl:w-[60px] 2xl:h-[60px]' viewBox="0 0 57 57" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link to={'/login'} className='flex flex-row text-white 2xl:text-[1.3vw]'>
