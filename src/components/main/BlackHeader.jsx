        ...
        <div className="flex justify-center mt-5">
            <div className="flex flex-row gap-10 w-[80vw] justify-between items-center">
                ...
                <div className="flex flex-row gap-5 md:gap-6 lg:gap-7 xl:gap-10 2xl:items-center">
                    ...
                    <div>
                        <Link to={'/favorite'} className='flex items-center justify-center bg-[#F8F8F8] rounded-[10px] w-[40px] h-[40px] 2xl:w-[60px] 2xl:h-[60px] cursor-pointer' >
            ...
            {/* Sidebar */}
            <div
                className={`fixed top-0 left-0 h-full w-[250px] bg-white transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
            ...
            >
                <div className="flex flex-col h-full p-6">
                    ...
                    <nav className="flex flex-col gap-2 font-eastman_regular text-[18px] text-black">
                        ...
                        <Link to="/beauty" onClick={toggleSidebar} className="hover:text-gray-500 mt-3">
                            Красота и здоровье
                        </Link>
                        <Link to="/cleaning" onClick={toggleSidebar} className="hover:text-gray-500">
                            Клининг
                        </Link>
                        <Link to="/tutoring" onClick={toggleSidebar} className="hover:text-gray-500">
                            Репетиторство
                        </Link>
                        <Link to="/building" onClick={toggleSidebar} className="hover:text-gray-500">
                            Строительство
                        </Link>
                        <Link to="/med-service" onClick={toggleSidebar} className="hover:text-gray-500">
                            Медицинские услуги
                        </Link>
                        {isAuthenticated ? (
                            <>
                                <Link to="/profile" onClick={toggleSidebar} className="hover:text-gray-500 mt-5">
                                    Профиль
                                </Link>
                                <button
                            ...
                            <Link to="/login" onClick={toggleSidebar} className="hover:text-gray-500">
                                Вход
                            </Link>
                        )}
                    </nav>
