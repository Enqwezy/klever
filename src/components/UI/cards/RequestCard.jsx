...
function RequestCard({ data }) {
    return (    
        <div className='bg-[#f8f8f8] font-eastman_regular flex flex-col gap-3 shadow-card rounded-[15px] mt-5 cursor-pointer md:flex-row-reverse md:min-h-[20vh] lg:min-h-[12vh] xl:max-h-[8vh] xl:min-h-[30vh] 2xl:pl-2 relative pb-3 md:pb-0 2xl:justify-between'>
            <div>
            ...
            <div className='md:p-3 md:text-left 2xl:justify-start 2xl:p-2'>
                ...
                <div className='md:flex md:flex-row gap-x-5 2xl:mt-0'>
                    ...
                    <div className='flex flex-row justify-center sm:text-[3vw] items-center lg:text-[1.7vw] xl:text-[1vw] 2xl:text-[1vw]'>
                        {data.rate}<svg className='md:size-[30px] size-[20px] xl:size-[20px] 2xl:size-[15px]' viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
